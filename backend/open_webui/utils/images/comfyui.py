...
class ComfyUIGenerateImageForm(ComfyUICreateImageForm):
    """Backwards-compatible alias for updated router expectations."""


async def comfyui_generate_image(
    model: str, payload: ComfyUIGenerateImageForm, client_id, base_url, api_key
):
    return await comfyui_create_image(model, payload, client_id, base_url, api_key)
